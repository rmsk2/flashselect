...
.text "selector"                           ; name of the program used for starting
.byte $00                                  ; zero termination for "mless"
.byte $00                                  ; no parameter description, i.e. an empty string
.text "Select program from cart"           ; Comment shown in lsf
...
BLOCK1 .dstruct BlockSpec_t, $80 - 64, 0, 3, 32  ; copy flash block $80 to RAM block 0. Start at offset $0300
